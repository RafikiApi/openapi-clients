...
export class BankApi {
    ...
    public setApiKey(key: BankApiApiKeys, value: string) {
        (this.authentications as any)[BankApiApiKeys[key]].apiKey = value;
    }
     ...
     * @summary List
     */
    public async banksGet (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: BanksGet200Response;  }> {
        const localVarPath = this.basePath + '/banks';
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: BanksGet200Response;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "BanksGet200Response");
