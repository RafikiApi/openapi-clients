...
/// struct for typed errors of method [`banks_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum BanksGetError {
...
pub async fn banks_get(configuration: &configuration::Configuration, ) -> Result<crate::models::BanksGet200Response, Error<BanksGetError>> {
    ...
    let local_var_uri_str = format!("{}/banks", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<BanksGetError> = serde_json::from_str(&local_var_content).ok();
