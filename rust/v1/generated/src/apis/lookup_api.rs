...
pub async fn lookups_account_number_get(configuration: &configuration::Configuration, payment_account_type: &str, account_number: &str, bank_id: Option<&str>) -> Result<crate::models::LookupsAccountNumberGet200Response, Error<LookupsAccountNumberGetError>> {
