...
pub async fn wallets_get(configuration: &configuration::Configuration, ) -> Result<crate::models::WalletsGet200Response, Error<WalletsGetError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<WalletsGetError> = serde_json::from_str(&local_var_content).ok();
