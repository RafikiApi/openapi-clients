...
/**
     ...
     * Get or create
     *
     * @param  \OpenAPI\Client\Model\OpenapiPaymentAccountGetOrCreateRequest $openapi_payment_account_get_or_create_request The payment account (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['paymentAccountsPost'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    {
        list($response) = $this->paymentAccountsPostWithHttpInfo($openapi_payment_account_get_or_create_request, $contentType);
        return $response;
    }

    /**
     * Operation paymentAccountsPostWithHttpInfo
     *
     * Get or create
     *
     * @param  \OpenAPI\Client\Model\OpenapiPaymentAccountGetOrCreateRequest $openapi_payment_account_get_or_create_request The payment account (required)
    ...
    /**
     * Operation paymentAccountsPostAsync
     *
     * Get or create
     *
     * @param  \OpenAPI\Client\Model\OpenapiPaymentAccountGetOrCreateRequest $openapi_payment_account_get_or_create_request The payment account (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function paymentAccountsPostAsync($openapi_payment_account_get_or_create_request, string $contentType = self::contentTypes['paymentAccountsPost'][0])
    {
        return $this->paymentAccountsPostAsyncWithHttpInfo($openapi_payment_account_get_or_create_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation paymentAccountsPostAsyncWithHttpInfo
     *
     * Get or create
     *
     * @param  \OpenAPI\Client\Model\OpenapiPaymentAccountGetOrCreateRequest $openapi_payment_account_get_or_create_request The payment account (required)
    ...
    /**
     * Create request for operation 'paymentAccountsPost'
     *
     * @param  \OpenAPI\Client\Model\OpenapiPaymentAccountGetOrCreateRequest $openapi_payment_account_get_or_create_request The payment account (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['paymentAccountsPost'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function paymentAccountsPostRequest($openapi_payment_account_get_or_create_request, string $contentType = self::contentTypes['paymentAccountsPost'][0])
    {

        // verify the required parameter 'openapi_payment_account_get_or_create_request' is set
        if ($openapi_payment_account_get_or_create_request === null || (is_array($openapi_payment_account_get_or_create_request) && count($openapi_payment_account_get_or_create_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $openapi_payment_account_get_or_create_request when calling paymentAccountsPost'
            );
        }
        ...
        // for model (json/xml)
        if (isset($openapi_payment_account_get_or_create_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($openapi_payment_account_get_or_create_request));
            } else {
                $httpBody = $openapi_payment_account_get_or_create_request;
            }
