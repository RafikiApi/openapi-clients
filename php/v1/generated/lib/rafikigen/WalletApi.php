...
/**
    ...
    {
        list($response) = $this->walletsGetWithHttpInfo($contentType);
        return $response;
    }
    ...
    {
        $request = $this->walletsGetRequest($contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\WalletsGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\WalletsGet200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\WalletsGet200Response', []),
     ...
     */
    public function walletsGetAsync(string $contentType = self::contentTypes['walletsGet'][0])
    {
        return $this->walletsGetAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function walletsGetAsyncWithHttpInfo(string $contentType = self::contentTypes['walletsGet'][0])
    {
        $returnType = '\OpenAPI\Client\Model\WalletsGet200Response';
        $request = $this->walletsGetRequest($contentType);
     ...
     */
    public function walletsGetRequest(string $contentType = self::contentTypes['walletsGet'][0])
    {
