...
class OpenapiPayoutCreateResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OpenapiPayoutCreateResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OpenapiPayoutCreateResponse:
        """Create an instance of OpenapiPayoutCreateResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OpenapiPayoutCreateResponse.parse_obj(obj)
