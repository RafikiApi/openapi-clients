...
class OpenapiPaymentAccountGetOrCreateResponseBankAccount(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OpenapiPaymentAccountGetOrCreateResponseBankAccount:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OpenapiPaymentAccountGetOrCreateResponseBankAccount:
        """Create an instance of OpenapiPaymentAccountGetOrCreateResponseBankAccount from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OpenapiPaymentAccountGetOrCreateResponseBankAccount.parse_obj(obj)
