...
class OpenapiPayoutCreateRequestSenderIndividualIdentityDocument(BaseModel):
    """
    OpenapiPayoutCreateRequestSenderIndividualIdentityDocument
    """
    country: Optional[StrictStr] = Field(None, description="<span style=\"color:#e95f6a;\">required if identity_document is provided</span>  The ISO 3166 alpha-2 country code indicating the issuing country of the document.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OpenapiPayoutCreateRequestSenderIndividualIdentityDocument:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OpenapiPayoutCreateRequestSenderIndividualIdentityDocument:
        """Create an instance of OpenapiPayoutCreateRequestSenderIndividualIdentityDocument from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OpenapiPayoutCreateRequestSenderIndividualIdentityDocument.parse_obj(obj)

        _obj = OpenapiPayoutCreateRequestSenderIndividualIdentityDocument.parse_obj({
