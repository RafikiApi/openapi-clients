...
class OpenapiResponseBodyWalletInsufficientBalance(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OpenapiResponseBodyWalletInsufficientBalance:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OpenapiResponseBodyWalletInsufficientBalance:
        """Create an instance of OpenapiResponseBodyWalletInsufficientBalance from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OpenapiResponseBodyWalletInsufficientBalance.parse_obj(obj)

        _obj = OpenapiResponseBodyWalletInsufficientBalance.parse_obj({
            "code": obj.get("code"),
