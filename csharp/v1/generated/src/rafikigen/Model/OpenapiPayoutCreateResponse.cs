...
namespace rafikigen.Model
{
    ...
    /// </summary>
    [DataContract(Name = "openapi.PayoutCreateResponse")]
    public partial class OpenapiPayoutCreateResponse : IEquatable<OpenapiPayoutCreateResponse>, IValidatableObject
    {
        /// <summary>
        /// Defines Purpose
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OpenapiPayoutCreateResponse" /> class.
        /// </summary>
        ...
        public OpenapiPayoutCreateResponse(OpenapiPayoutCreateResponseAmount amount = default(OpenapiPayoutCreateResponseAmount), string createdAt = default(string), string customId = default(string), string id = default(string), List<string> onBehalfOf = default(List<string>), string paymentAccountId = default(string), PurposeEnum? purpose = default(PurposeEnum?), OpenapiPayoutCreateResponseSender sender = default(OpenapiPayoutCreateResponseSender), OpenapiPayoutCreateResponseState state = default(OpenapiPayoutCreateResponseState), string walletId = default(string))
        {
            this.Amount = amount;
        ...
        {
            return this.Equals(input as OpenapiPayoutCreateResponse);
        }

        /// <summary>
        /// Returns true if OpenapiPayoutCreateResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of OpenapiPayoutCreateResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OpenapiPayoutCreateResponse input)
        {
            if (input == null)
            {
                return false;
