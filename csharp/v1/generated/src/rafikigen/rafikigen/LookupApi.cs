...
namespace rafikigen.rafikigen
{
    ...
    public interface ILookupApiSync : IApiAccessor
    {
        ...
        LookupsAccountNumberGet200Response LookupsAccountNumberGet(string paymentAccountType, string accountNumber, string? bankId = default(string?), int operationIndex = 0);
        ...
        ApiResponse<LookupsAccountNumberGet200Response> LookupsAccountNumberGetWithHttpInfo(string paymentAccountType, string accountNumber, string? bankId = default(string?), int operationIndex = 0);
    ...
    public interface ILookupApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<LookupsAccountNumberGet200Response> LookupsAccountNumberGetAsync(string paymentAccountType, string accountNumber, string? bankId = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<LookupsAccountNumberGet200Response>> LookupsAccountNumberGetWithHttpInfoAsync(string paymentAccountType, string accountNumber, string? bankId = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class LookupApi : ILookupApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>LookupsAccountNumberGet200Response</returns>
        public LookupsAccountNumberGet200Response LookupsAccountNumberGet(string paymentAccountType, string accountNumber, string? bankId = default(string?), int operationIndex = 0)
        {
            rafikigen.Client.ApiResponse<LookupsAccountNumberGet200Response> localVarResponse = LookupsAccountNumberGetWithHttpInfo(paymentAccountType, accountNumber, bankId);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of LookupsAccountNumberGet200Response</returns>
        public rafikigen.Client.ApiResponse<LookupsAccountNumberGet200Response> LookupsAccountNumberGetWithHttpInfo(string paymentAccountType, string accountNumber, string? bankId = default(string?), int operationIndex = 0)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of LookupsAccountNumberGet200Response</returns>
        public async System.Threading.Tasks.Task<LookupsAccountNumberGet200Response> LookupsAccountNumberGetAsync(string paymentAccountType, string accountNumber, string? bankId = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            rafikigen.Client.ApiResponse<LookupsAccountNumberGet200Response> localVarResponse = await LookupsAccountNumberGetWithHttpInfoAsync(paymentAccountType, accountNumber, bankId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
