  ...
  class BankApi
    ...
    def banks_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: BankApi.banks_get ...'
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'BanksGet200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Bearer']

      new_options = opts.merge(
        :operation => :"BankApi.banks_get",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: BankApi#banks_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
