...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Resources.OpenapiPayoutCreateResponseSenderAddress();
  });
  ...
  describe('OpenapiPayoutCreateResponseSenderAddress', function() {
    it('should create an instance of OpenapiPayoutCreateResponseSenderAddress', function() {
      // uncomment below and update the code to test OpenapiPayoutCreateResponseSenderAddress
      //var instance = new Resources.OpenapiPayoutCreateResponseSenderAddress();
      //expect(instance).to.be.a(Resources.OpenapiPayoutCreateResponseSenderAddress);
    });
