...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Resources.OpenapiPaymentAccountGetOrCreateResponse();
  });
  ...
  describe('OpenapiPaymentAccountGetOrCreateResponse', function() {
    it('should create an instance of OpenapiPaymentAccountGetOrCreateResponse', function() {
      // uncomment below and update the code to test OpenapiPaymentAccountGetOrCreateResponse
      //var instance = new Resources.OpenapiPaymentAccountGetOrCreateResponse();
      //expect(instance).to.be.a(Resources.OpenapiPaymentAccountGetOrCreateResponse);
    });
