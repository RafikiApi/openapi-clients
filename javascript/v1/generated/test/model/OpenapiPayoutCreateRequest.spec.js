...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Resources.OpenapiPayoutCreateRequest();
  });
  ...
  describe('OpenapiPayoutCreateRequest', function() {
    it('should create an instance of OpenapiPayoutCreateRequest', function() {
      // uncomment below and update the code to test OpenapiPayoutCreateRequest
      //var instance = new Resources.OpenapiPayoutCreateRequest();
      //expect(instance).to.be.a(Resources.OpenapiPayoutCreateRequest);
    });
